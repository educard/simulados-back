...
insert into areas (name)
values ('Direito comercial ou empresarial');
insert into areas (name)
values ('Direito da tecnologia da informação');
insert into areas (name)
values ('Direito tributário');
insert into areas (name)
values ('Direito administrativo');
insert into areas (name)
values ('Direito previdenciário');
insert into areas (name)
values ('Direito penal ou criminal');
insert into areas (name)
values ('Mediação, conciliação e arbitragem');

insert into subareas (name, area_id)
values ('Não Cadastrado', 1);
insert into subareas (name, area_id)
values ('Direito contratual', 2);
insert into subareas (name, area_id)
values ('Direito de família', 2);
insert into subareas (name, area_id)
values ('Direito das coisas', 2);
insert into subareas (name, area_id)
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (5,  1, 1, 1, 'Fabiano é conselheiro eleito de certo Conselho Seccional da OAB. No curso do mandato Fabiano pratica infração disciplinar e sofre condenação em definitivo à pena de censura. Considerando a situação descrita e o disposto no Estatuto da OAB o mandato de Fabiano no Conselho Seccional', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (5, 5, 5, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (6,  1, 1, 1, 'Charles é presidente de certo Conselho Seccional da OAB. Não obstante no curso do mandato Charles vê-se envolvido em dificuldades no seu casamento com Emma e decide renunciar ao mandato para dedicar-se às suas questões pessoais. Sobre o caso assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (6, 6, 6, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (11,  1, 1, 1, 'A partir da leitura de Aristóteles (Ética a Nicômaco) assinale a alternativa que corresponde à classificação de justiça constante do texto: “... uma espécie é a que se manifesta nas distribuições de honras de dinheiro ou das outras coisas que são divididas entre aqueles que têm parte na constituição (pois aí é possível receber um quinhão igual ou desigual ao de um outro)...”', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (11, 11, 11, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (26,  1, 1, 1, 'Fulano de Tal prometeu adquirir de uma autarquia federal um imóvel residencial urbano. O sinal e parte substancial do preço são pagos no momento da lavratura da escritura pública de promessa de compra e venda que é prontamente registrada no Registro Geral de Imóveis (RGI) competente. O saldo do preço será pago em várias parcelas. Após o registro da promessa de compra e venda', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (26, 26, 26, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (27,  1, 1, 1, 'O Estado Alfa institui por meio de lei complementar uma taxa pela prestação de serviço público específico e divisível. Posteriormente a alíquota e a base de cálculo da taxa vêm a ser modificadas por meio de lei ordinária que as mantém em patamares compatíveis com a natureza do tributo e do serviço público prestado. A lei ordinária em questão é', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (27, 27, 27, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (28,  1, 1, 1, 'Após verificar que realizou o pagamento indevido de Imposto sobre Circulação de Mercadorias e Serviços - ICMS determinado contribuinte requer administrativamente a restituição do valor recolhido. O órgão administrativo competente denega o pedido de restituição. Qual o prazo bem como o marco inicial para o contribuinte ajuizar ação anulatória da decisão administrativa que denega a restituição?', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (28, 28, 28, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (29,  1, 1, 1, 'Determinada empresa apresenta impugnação ao edital de concessão do serviço público metroviário em determinado Estado sob a alegação de que a estipulação do retorno ao poder concedente de todos os bens reversíveis já amortizados quando do advento do termo final do contrato ensejaria enriquecimento sem causa do Estado. Assinale a opção que indica o princípio que justifica tal previsão editalícia.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (29, 29, 29, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (30,  1, 1, 1, 'Paulo é servidor concursado da Câmara de Vereadores do município Beta há mais de quinze anos. Durante esse tempo Paulo concluiu cursos de aperfeiçoamento profissional graduou-se no curso de economia exerceu cargos em comissão e foi promovido por merecimento. Todos esses fatores contribuíram para majorar sua remuneração. Considerando a disciplina constitucional a respeito dos servidores públicos assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (30, 30, 30, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (36,  1, 1, 1, 'No curso de obra pública de construção de represa para fins de geração de energia hidrelétrica em rio que corta dois estados da Federação a associação privada Sorrio propõe ação civil pública buscando a reconstituição do ambiente ao status quo anterior ao do início da construção por supostos danos ao meio ambiente. Considerando a hipótese assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (36, 36, 36, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (39,  1, 1, 1, 'Vítor Paulo e Márcia são coproprietários em regime de condomínio pro indiviso de uma casa sendo cada um deles titular de parte ideal representativa de um terço (1/3) da coisa comum. Todos usam esporadicamente a casa nos finais de semana. Certo dia ao visitar a casa Márcia descobre um vazamento no encanamento de água. Sem perder tempo contrata em nome próprio uma sociedade empreiteira para a realização da substituição do cano danificado. Pelo serviço ficou ajustado contratualmente o pagamento de R$ 900 00 (novecentos reais). Tendo em vista os fatos expostos assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (39, 39, 39, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (42,  1, 1, 1, 'Maria trabalhadora autônoma foi atropelada por um ônibus da Viação XYZ S.A. quando atravessava movimentada rua da cidade sofrendo traumatismo craniano. No caminho do hospital Maria veio a falecer deixando o marido João e o filho Daniel menor impúbere que dela dependiam economicamente. Sobre o caso assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (42, 42, 42, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (49,  1, 1, 1, 'Mostardas Tavares & Cia Ltda. EPP requereu sua recuperação judicial tendo o pedido sido despachado pelo juiz com a nomeação de Frederico Portela como administrador judicial. Em relação à remuneração do administrador judicial será observada a seguinte regra:', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (49, 49, 49, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (52,  1, 1, 1, 'Na sociedade Apuí Veículos Ltda. a sócia Eva foi eleita administradora pela unanimidade dos sócios para um mandato de três anos. Em razão de insuperáveis divergências com os demais administradores sobre a condução dos negócios Eva renunciou ao cargo após um ano de sua investidura. A eficácia da renúncia de Eva se dará em relação à sociedade desde o momento em que', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (52, 52, 52, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (53,  1, 1, 1, 'Distribuída a ação Antônia (autora) é intimada para a audiência de conciliação na pessoa de seu advogado. Explicado o objetivo desse ato pelo advogado Antônia informa que se recusa a participar da audiência porque não tem qualquer possibilidade de conciliação com Romero (réu). Acerca da audiência de conciliação ou de mediação com base no CPC/15 assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (53, 53, 53, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (58,  1, 1, 1, 'Durante uma ação de guarda a tramitar em uma vara de família a ré mãe da criança descobriu que o advogado do pai (autor) é filho adotivo do irmão do promotor de justiça que atua no caso. Extremamente preocupada informou o fato ao seu advogado. Com base no CPC/15 como advogado da mãe assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (58, 58, 58, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (59,  1, 1, 1, 'Guilherme funcionário público de determinada repartição pública do Estado do Paraná enquanto organizava os arquivos de sua repartição acabou por desatenção jogando ao lixo juntamente com materiais inúteis um importante livro oficial que veio a se perder. Considerando apenas as informações narradas é correto afirmar que a conduta de Guilherme', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (59, 59, 59, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (64,  1, 1, 1, 'Durante dois meses Mário 45 anos e Joana 14 anos mantiveram relações sexuais em razão de relacionamento amoroso. Apesar do consentimento de ambas as partes ao tomar conhecimento da situação o pai de Joana revoltado comparece à Delegacia e narra o ocorrido para a autoridade policial esclarecendo que o casal se conhecera no dia do aniversário de 14 anos de sua filha. Considerando apenas as informações narradas é correto afirmar que a conduta de Mário', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (64, 64, 64, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (65,  1, 1, 1, 'José Augusto foi preso em flagrante delito pela suposta prática do crime de receptação (Art. 180 do Código Penal – pena: 01 a 04 anos de reclusão e multa). Em que pese seja tecnicamente primário e de bons antecedentes e seja civilmente identificado possui em sua Folha de Antecedentes Criminais duas anotações pela prática de crimes patrimoniais sem que essas ações tenham resultados definitivos. Neste caso de acordo com as previsões expressas do Código de Processo Penal assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (65, 65, 65, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (68,  1, 1, 1, 'Guilherme foi denunciado pela prática de um crime de lesão corporal seguida de morte. Após o recebimento da denúncia Guilherme é devidamente citado. Em conversa com sua defesa técnica Guilherme apresenta prova inequívoca de que agiu em estado de necessidade. Diante da situação narrada o advogado de Guilherme em resposta à acusação deverá requerer a', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (68, 68, 68, 1);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (82,  1, 1, 1, 'O advogado Roni foi presidente do Conselho Federal da OAB em mandato exercido por certo triênio na década entre 2000 e 2010. Sobre a participação de Roni na condição de ex- presidente do Conselho Federal nas sessões do referido Conselho assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (82, 2, 82, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (91,  1, 1, 1, 'De acordo com o contratualismo proposto por Thomas Hobbes em sua obra Leviatã o contrato social só é possível em função de uma lei da natureza que expresse segundo o autor a própria ideia de justiça. Assinale a opção que segundo o autor na obra em referência apresenta esta lei da natureza.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (91, 11, 91, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (101,  1, 1, 1, 'Maria deu entrada em uma maternidade pública já em trabalho de parto. Contudo a falta de pronto atendimento levou a óbito tanto Maria quanto o bebê. Você foi contratado(a) pela família de Maria para advogar neste caso de grave violação de Direitos Humanos. Após algumas rápidas pesquisas na Internet o pai e a mãe de Maria pedem que o caso seja imediatamente encaminhado para julgamento na Corte Interamericana de Direitos Humanos. Você como advogado(a) da família deve esclarecer que', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (101, 21, 101, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (104,  1, 1, 1, 'Aurélio diplomata brasileiro casado e pai de dois filhos menores está em vias de ser nomeado chefe de missão do Brasil na capital de importante Estado europeu. À luz do disposto na Convenção de Viena sobre Relações Diplomáticas promulgada no Brasil por meio do Decreto nº 56.435/65 assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (104, 24, 104, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (110,  1, 1, 1, 'Uma autarquia federal divulgou edital de licitação para a concessão da exploração de uma rodovia que interliga diversos Estados da Federação. A exploração do serviço será precedida de obras de duplicação da rodovia. Como o fluxo esperado de veículos não é suficiente para garantir por meio do pedágio a amortização dos investimentos e a remuneração do concessionário haverá adicionalmente à cobrança do pedágio contraprestação pecuniária por parte do Poder Público. Sobre a hipótese apresentada assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (110, 30, 110, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (116,  1, 1, 1, 'O Governo Federal tendo em vista a grande dificuldade em conter o desmatamento irregular em florestas públicas iniciou procedimento de concessão florestal para que particulares possam explorar produtos e serviços florestais. Sobre o caso assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (116, 36, 116, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (119,  1, 1, 1, 'João e Maria casaram-se no regime de comunhão parcial de bens em 2004. Contudo em 2008 João conheceu Vânia e eles passaram a ter um relacionamento amoroso. Separando- se de fato de Maria João saiu da casa em que morava com Maria e foi viver com Vânia apesar de continuar casado com Maria. Em 2016 João muito feliz em seu novo relacionamento resolve dar de presente um carro 0 km da marca X para Vânia. Considerando a narrativa apresentada sobre o contrato de doação celebrado entre João doador e Vânia donatária assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (119, 39, 119, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (127,  1, 1, 1, 'O Banco X enviou um cartão de crédito para Jeremias com limite de R$ 10.000 00 (dez mil reais) para uso em território nacional e no exterior incluindo seguro de vida e acidentes pessoais bem como seguro contra roubo e furto no importe total de R$ 5 00 (cinco reais) na fatura mensal além da anuidade de R$ 400 00 (quatrocentos reais) parcelada em cinco vezes. Jeremias recebeu a correspondência contendo um cartão bloqueado o contrato e o informativo de benefícios e ônus. Ocorre que Jeremias não é cliente do Banco X e sequer solicitou o cartão de crédito. Sobre a conduta da instituição bancária considerando a situação narrada e o entendimento do STJ expresso em Súmula assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (127, 47, 127, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (128,  1, 1, 1, 'Rosana e Carolina pretendem reunir esforços para empreender uma atividade econômica constituindo uma Empresa Individual de Responsabilidade Limitada (EIRELI). Essa iniciativa será possível se observada a seguinte condição:', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (128, 48, 128, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (131,  1, 1, 1, 'Humaitá Comércio e Distribuição de Defensivos Agrícolas Ltda. sacou 4 (quatro) duplicatas de compra e venda em face de Cooperativa dos Produtores Rurais de Coari Ltda. em razão da venda de insumos para as plantações dos cooperados. Com base nestas informações assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (131, 51, 131, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (132,  1, 1, 1, 'Bernardino adquiriu de Lorena ações preferenciais escriturais da companhia Campos Logística S/A e recebeu do(a) advogado(a) orientação de como se dará a formalização da transferência da propriedade. A resposta do(a) advogado(a) é a de que a transferência das ações se opera', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (132, 52, 132, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (133,  1, 1, 1, 'Lucas foi citado para apresentar defesa em ação de indenização por danos materiais em razão de acidente de veículo. Contudo o proprietário e condutor do veículo que causou o acidente era Cláudio seu primo com quem Lucas havia pego uma carona. Lucas em contestação deverá', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (133, 53, 133, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (140,  1, 1, 1, 'Carlos 21 anos foi condenado a cumprir pena de prestação de serviços à comunidade pela prática de um crime de lesão corporal culposa no trânsito. Em 01/01/2014 seis meses após cumprir a pena restritiva de direitos aplicada praticou novo crime de natureza culposa vindo a ser denunciado. Carlos após não aceitar qualquer benefício previsto na Lei nº 9.099/95 e ser realizada audiência de instrução e julgamento é novamente condenado em 17/02/2016. O juiz aplica pena de 11 meses de detenção não admitindo a substituição por restritiva de direitos em razão da reincidência. Considerando que os fatos são verdadeiros e que o Ministério Público não apelou o(a) advogado(a) de Carlos sob o ponto de vista técnico deverá requerer em recurso ', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (140, 60, 140, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (141,  1, 1, 1, 'Carlos presta serviço informal como salva-vidas de um clube não sendo regularmente contratado apesar de receber uma gorjeta para observar os sócios do clube na piscina durante toda a semana. Em seu horário de “serviço” com várias crianças brincando na piscina fica observando a beleza física da mãe de uma das crianças e ao mesmo tempo falando no celular com um amigo acabando por ficar de costas para a piscina. Nesse momento uma criança vem a falecer por afogamento fato que não foi notado por Carlos. Sobre a conduta de Carlos diante da situação narrada assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (141, 61, 141, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (153,  1, 1, 1, 'Paula e Joyce são empregadas de uma mesma sociedade empresária. O irmão de Paula faleceu e o empregador não autorizou sua ausência ao trabalho. Vinte dias depois Joyce se casou e o empregador também não autorizou sua ausência ao trabalho em nenhum dia. Como advogado(a) das empregadas você deverá requerer', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (153, 73, 153, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (157,  1, 1, 1, 'De acordo com o entendimento consolidado do STF e do TST assinale a opção que apresenta situação em que a Justiça do Trabalho possui competência para executar as contribuições devidas ao INSS.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (157, 77, 157, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (158,  1, 1, 1, 'Em pedido de reenquadramento formulado em reclamação trabalhista foi designada perícia com honorários adiantados pelo autor e ambas as partes indicaram assistentes técnicos. Após a análise das provas o pedido foi julgado procedente. Diante da situação da legislação em vigor e do entendimento consolidado do TST assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (158, 78, 158, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (159,  1, 1, 1, 'Em determinada reclamação trabalhista o empregador foi condenado ao pagamento de diversas parcelas havendo ainda condenação subsidiária da União na condição de tomadora dos serviços. Na execução depois de homologado o cálculo e citado o empregador para pagamento as tentativas de recebimento junto ao devedor principal fracassaram daí porque a execução foi direcionada contra a União que agora pretende questionar o valor da dívida. Diante da situação apresentada assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (159, 79, 159, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (160,  1, 1, 1, 'Um empregado ajuizou reclamação trabalhista postulando o pagamento de vale transporte jamais concedido durante o contrato de trabalho bem como o FGTS não depositado durante o pacto laboral. Em contestação a sociedade empresária advogou que em relação ao vale transporte o empregado não satisfazia os requisitos indispensáveis para a concessão; no tocante ao FGTS disse que os depósitos estavam regulares. Em relação à distribuição do ônus da prova diante desse panorama processual e do entendimento consolidado pelo TST assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (160, 80, 160, 2);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (161,  1, 1, 1, 'Marcelo renomado advogado foi convidado para participar de matéria veiculada pela Internet por meio de portal de notícias com a finalidade de informar os leitores sobre direitos do consumidor. Ao final da matéria mediante sua autorização foi divulgado o e-mail de Marcelo bem como o número de telefone do seu escritório. Sobre essa situação de acordo com o Código de Ética e Disciplina da OAB assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (161, 1, 161, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (164,  1, 1, 1, 'Em determinada subseção da OAB constatou-se grave violação à disciplina prevista na Lei nº 8.906/94 no que diz respeito ao exercício de suas atribuições de representar a OAB perante os poderes constituídos e de fazer valer as prerrogativas do advogado. Considerando a situação hipotética narrada assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (164, 4, 164, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (166,  1, 1, 1, 'Carolina Júlia Bianca e Maria são advogadas. Carolina é servidora estadual não enquadrada em hipótese de incompatibilidade; Júlia está cumprindo suspensão por infração disciplinar; Bianca está licenciada por requerimento próprio justificado; e Maria é servidora federal não enquadrada em hipótese de incompatibilidade. As quatro peticionam como advogadas isoladamente e em atos distintos em ação judicial proposta em face da União. Diante da situação narrada de acordo com o Estatuto da OAB são válidos os atos praticados', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (166, 6, 166, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (167,  1, 1, 1, 'O Conselho Seccional X da OAB criou dez subseções e uma Caixa de Assistência dos Advogados. Dentre as subseções inclui-se a Subseção Y cuja área territorial abrange um município. Considerando a hipótese narrada analise as afirmativas a seguir e assinale a única correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (167, 7, 167, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (168,  1, 1, 1, 'Viviane Paula e Milena são advogadas. Viviane acaba de dar à luz Paula adotou uma criança e Milena está em período de amamentação. Diante da situação narrada de acordo com o Estatuto da OAB assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (168, 8, 168, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (185,  1, 1, 1, 'João e Pedro são por lei contribuintes obrigados solidariamente a pagar determinado tributo. Foi publicada lei que isenta os ex-combatentes do pagamento de tal tributo sendo este o caso pessoal somente de João. Tendo em vista essa situação assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (185, 25, 185, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (186,  1, 1, 1, 'O Município X instituiu taxa a ser cobrada exclusivamente sobre o serviço público de coleta remoção e tratamento de lixo e resíduos provenientes de imóveis. A igreja ABC com sede no Município X foi notificada da cobrança da referida taxa. Sobre a hipótese apresentada assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (186, 26, 186, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (191,  1, 1, 1, 'A Administração Federal irá realizar sucessivos contratos de compra de produtos de papelaria de uso contínuo nos órgãos para os quais os bens estão destinados. Para tanto pretende fazer uso dos mecanismos legais que melhor atendam ao princípio da eficiência. No caso acerca da modalidade de licitação a ser adotada assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (191, 31, 191, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (192,  1, 1, 1, 'A Associação Delta se dedica à promoção do voluntariado e foi qualificada como Organização da Sociedade Civil sem fins lucrativos – OSCIP após o que formalizou termo de parceria com a União por meio do qual recebeu recursos que aplicou integralmente na realização de suas atividades inclusive na aquisição de um imóvel que passou a ser a sede da entidade. Com base nessa situação hipotética assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (192, 32, 192, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (203,  1, 1, 1, 'George vende para Marília um terreno não edificado de sua propriedade enfatizando a existência de uma “vista eterna para a praia” que se encontra muito próxima do imóvel mesmo sem qualquer documento comprovando o fato. Marília adquire o bem mas dez anos após a compra é surpreendida com a construção de um edifício de vinte andares exatamente entre o seu terreno e o mar impossibilitando totalmente a vista que George havia prometido ser eterna. Diante do exposto e considerando que a construção do edifício ocorreu em um terreno de terceiro assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (203, 43, 203, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (210,  1, 1, 1, 'Mauriti & Cia Ltda. celebrou contrato de alienação fiduciária em garantia com a sociedade empresária Gama. Com a decretação de falência da fiduciante o advogado da fiduciária pleiteou a restituição do bem alienado sendo informado pelo administrador judicial que o bem se encontrava na posse do falido na época da decretação da falência porém não foi encontrado para ser arrecadado. Considerando os fatos narrados o credor fiduciário terá direito à restituição em dinheiro do valor da avaliação do bem atualizado?', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (210, 50, 210, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (230,  1, 1, 1, 'Lino trabalha como diagramador na sociedade empresária XYZ Ltda. localizada em um grande centro urbano e recebe do empregador além do salário moradia e plano de assistência odontológica graciosamente. Sobre o caso narrado de acordo com a CLT assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (230, 70, 230, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (232,  1, 1, 1, 'Pedro é empregado da sociedade empresária X e em determinado mês recebeu diárias na ordem de 70% do seu salário sem ter prestado qualquer conta ao empregador. De acordo com a CLT e o entendimento consolidado do TST assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (232, 72, 232, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (235,  1, 1, 1, 'Suely trabalha na casa de Rogério como cuidadora de seu pai pessoa de idade avançada e enferma comparecendo de segunda a sexta-feira das 8:00 às 17:00 h com intervalo de uma hora para refeição. De acordo com o caso narrado e a legislação de regência assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (235, 75, 235, 3);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (242,  1, 1, 1, 'O advogado Inácio foi indicado para defender em juízo pessoa economicamente hipossuficiente pois no local onde atua não houve disponibilidade de defensor público para tal patrocínio. Sobre o direito de Inácio à percepção de honorários assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (242, 2, 242, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (243,  1, 1, 1, 'A advogada Ana encontra-se no quinto mês de gestação. Em razão de exercer a profissão como única patrona nas causas em que atua ela receia encontrar algumas dificuldades durante a gravidez e após o parto. Considerando o caso narrado assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (243, 3, 243, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (258,  1, 1, 1, 'Há cerca de três meses foi verificado que os presos da Penitenciária Quebrantar estavam sofrendo diversas formas de maus tratos incluindo violência física. Você foi contratado(a) por familiares dos presos que lhe disseram ter elementos suficientes para acreditar que qualquer medida judicial no Brasil seria ineficaz no prazo desejado. Por isso eles o(a) consultaram sobre a possibilidade de submeter o caso à Comissão Interamericana de Direitos Humanos (CIDH). Considerando as regras de funcionamento dessa Comissão você deve informá-los de que a CIDH pode receber a denúncia:', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (258, 18, 258, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (262,  1, 1, 1, 'João e Maria celebraram entre si contrato de locação sendo João o locador e proprietário do imóvel. No contrato eles estipularam que a responsabilidade pelo pagamento do Imposto sobre a Propriedade Predial e Territorial Urbana (IPTU) do imóvel será de Maria locatária. Com base nessas informações assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (262, 22, 262, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (266,  1, 1, 1, 'A pessoa jurídica A declarou débitos de Imposto sobre a Renda (IRPJ) que no entanto deixaram de ser quitados. Diante do inadimplemento da contribuinte a União promoveu o protesto da Certidão de Dívida Ativa (CD', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (266, 26, 266, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (268,  1, 1, 1, 'Marcelo é médico do Corpo de Bombeiros Militar do Estado Beta e foi aprovado em concurso público para o cargo de médico civil junto a um determinado hospital da União que é uma autarquia federal. A partir do fato apresentado acerca da acumulação de cargos públicos assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (268, 28, 268, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (270,  1, 1, 1, 'Determinado município é proprietário de um extenso lote localizado em área urbana mas que não vem sendo utilizado pela Administração há anos. Em consequência do abandono o imóvel foi ocupado por uma família de desempregados que deu à área uma função social. O poder público teve ciência do fato mas como se tratava do final da gestão do então prefeito não tomou qualquer medida para que o bem fosse desocupado. A situação perdurou mais de trinta anos até que o município ajuizou a reintegração de posse. Sobre a questão apresentada assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (270, 30, 270, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (272,  1, 1, 1, 'Um Estado da Federação lançou um grande programa de concessões como forma de fomentar investimentos diante das dificuldades financeiras por que vem passando. Por meio desse programa ele pretende executar obras de interesse da população e ceder espaços públicos para a gestão da iniciativa privada. Como parte desse programa lançou edital para restaurar um complexo esportivo com estádio de futebol ginásio de esportes parque aquático e quadras poliesportivas. Diante da situação acima assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (272, 32, 272, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (274,  1, 1, 1, 'Bolão Ltda. sociedade empresária pretende iniciar atividade de distribuição de pneus no mercado brasileiro. Para isso contrata uma consultoria para dentre outros elementos avaliar sua responsabilidade pela destinação final dos pneus que pretende comercializar. Sobre o caso assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (274, 34, 274, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (286,  1, 1, 1, 'Miguel e Paulo pretendem constituir uma sociedade do tipo limitada porque não pretendem responder subsidiariamente pelas obrigações sociais. Na consulta a um advogado previamente à elaboração do contrato foram informados de que nesse tipo societário todos os sócios respondem', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (286, 46, 286, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (289,  1, 1, 1, 'A sociedade empresária Pará de Minas Veículos Ltda. pretende requerer sua recuperação judicial. Ao analisar a minuta de petição inicial o gerente administrativo listou os impedimentos ao pedido de recuperação. Assinale a opção que apresenta um desses impedimentos.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (289, 49, 289, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (310,  1, 1, 1, 'Solange é comissária de bordo em uma grande empresa de transporte aéreo e ajuizou reclamação trabalhista postulando adicional de periculosidade alegando que permanecia em área de risco durante o abastecimento das aeronaves porque ele era feito com a tripulação a bordo. Iracema vizinha de Solange trabalha em uma unidade fabril recebendo adicional de insalubridade mas após cinco anos sua atividade foi retirada da lista de atividades insalubres por ato da autoridade competente. Sobre as duas situações segundo a norma de regência e o entendimento consolidado do TST assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (310, 70, 310, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (312,  1, 1, 1, 'Carlos professor de educação física e fisioterapeuta trabalhou para a Academia Boa Forma S/A que assinou sua CTPS. Cumpria jornada de segunda a sexta-feira das 7h às 16h com uma hora de intervalo para almoço. Ao longo da jornada de trabalho ele ministrava quatro aulas de ginástica com 50 minutos de duração cada e também fazia atendimentos fisioterápicos previamente marcados pelos alunos da Academia na sociedade empresária Siga em Boa Forma Ltda. do mesmo grupo econômico da Academia sem ter sua CTPS anotada. Dispensado Carlos pretende ajuizar ação trabalhista. Diante disso em relação ao vínculo de emprego de Carlos assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (312, 72, 312, 4);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (323,  1, 1, 1, 'O Tribunal de Ética e Disciplina de certo Conselho Seccional da OAB decidiu pela suspensão preventiva do advogado Hélio acusado em processo disciplinar. Hélio todavia interpôs o recurso cabível contra tal decisão. Considerando as regras sobre os recursos em processos que tramitam perante a OAB bem como a situação descrita assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (323, 3, 323, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (326,  1, 1, 1, 'O advogado Ícaro dos Santos regularmente constituído para a defesa judicial de certo cliente necessitou para o correto exercício do mandato que o cliente lhe apresentasse alguns documentos. Após Ícaro solicitar-lhe os documentos diversas vezes realizando inúmeras tentativas de contato o cliente manteve-se inerte por prazo superior a três meses. Considerando o caso narrado assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (326, 6, 326, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (329,  1, 1, 1, 'A ideia da existência de lacuna é um desafio ao conceito de completude do ordenamento jurídico. Segundo o jusfilósofo italiano Norberto Bobbio no livro Teoria do Ordenamento Jurídico pode-se completar ou integrar as lacunas existentes no Direito por intermédio de dois métodos a saber: heterointegração e autointegração. Assinale a opção que explica como o jusfilósofo define tais conceitos na obra em referência.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (329, 9, 329, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (330,  1, 1, 1, 'Uma punição só pode ser admitida na medida em que abre chances no sentido de evitar um mal maior. Jeremy Bentham Jeremy Bentham em seu livro Princípios da Moral e da Legislação afirma que há quatro casos em que não se deve infligir uma punição. Assinale a opção que corresponde a um desses casos citados pelo autor na obra em referência.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (330, 10, 330, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (332,  1, 1, 1, 'O chefe do Poder Executivo do município Ômega mediante decisão administrativa resolve estender aos servidores inativos do município o direito ao auxílio-alimentação contrariando a Súmula Vinculante nº 55 do Supremo Tribunal Federal. Para se insurgir contra a situação apresentada assinale a opção que indica a medida judicial que deve ser adotada.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (332, 12, 332, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (337,  1, 1, 1, 'Policiais militares do estado Y decidiram entrar em greve em razão dos atrasos salariais e por considerarem inadequadas as condições de trabalho. Em razão desse quadro a Associação de Esposas e Viúvas dos Policiais Militares procura um advogado para saber da constitucionalidade dessa decisão dos policiais militares. Sobre a hipótese apresentada assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (337, 17, 337, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (341,  1, 1, 1, 'Paulo brasileiro celebra no Brasil um contrato de prestação de serviços de consultoria no Brasil a uma empresa pertencente a François francês residente em Paris para a realização de investimentos no mercado imobiliário brasileiro. O contrato possui uma cláusula indicando a aplicação da lei francesa. Em ação proposta por Paulo no Brasil surge uma questão envolvendo a capacidade de François para assumir e cumprir as obrigações previstas no contrato. Com relação a essa questão a Justiça brasileira deverá aplicar', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (341, 21, 341, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (343,  1, 1, 1, 'Devido à crise que vem atingindo o Estado Y seu governador após examinar as principais reclamações dos contribuintes decidiu estabelecer medidas que facilitassem o pagamento do Imposto sobre a Propriedade de Veículos Automotores (IPVA). Por meio de despacho administrativo autorizado por lei perdoou débitos de IPVA iguais ou inferiores a R$ 300 00 (trezentos reais) na época da publicação. Além disso sancionou lei prorrogando o prazo para pagamento dos débitos de IPVA já vencidos. Com base no caso apresentado assinale a opção que indica os institutos tributários utilizados pelo governo respectivamente.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (343, 23, 343, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (344,  1, 1, 1, 'Em 2015 o Município X estabeleceu por meio da Lei nº 123 alíquotas progressivas do Imposto sobre propriedade Predial e Territorial Urbana (IPTU) tendo em conta o valor do imóvel. Sobre a hipótese assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (344, 24, 344, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (349,  1, 1, 1, 'João foi aprovado em concurso público para ocupar um cargo federal. Depois de nomeado tomou posse e entrou em exercício imediatamente. Porém em razão da sua baixa produtividade o órgão ao qual João estava vinculado entendeu que o servidor não satisfez as condições do estágio probatório. Considerando o Estatuto dos Servidores Públicos Civis da União à luz do caso narrado assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (349, 29, 349, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (350,  1, 1, 1, 'A União celebrou com a empresa Gama contrato de concessão de serviço público precedida de obra pública. O negócio jurídico tinha por objeto a exploração incluindo a duplicação de determinada rodovia federal. Algum tempo após o início do contrato o poder concedente identificou a inexecução de diversas obrigações por parte da concessionária o que motivou a notificação da contratada. Foi autuado processo administrativo ao fim do qual o poder concedente concluiu estar prejudicada a prestação do serviço por culpa da contratada. Com base na hipótese apresentada assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (350, 30, 350, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (354,  1, 1, 1, 'Os Municípios ABC e XYZ estabeleceram uma solução consorciada intermunicipal para a gestão de resíduos sólidos. Nesse sentido celebraram um consórcio para estabelecer as obrigações e os procedimentos operacionais relativos aos resíduos sólidos de serviços de saúde gerados por ambos os municípios. Sobre a validade do plano intermunicipal de resíduos sólidos assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (354, 34, 354, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (359,  1, 1, 1, 'Mário cego viúvo faleceu em 1º de junho de 2017 deixando 2 filhos: Clara casada com Paulo e Júlio solteiro. Em seu testamento público feito de acordo com as formalidades legais em 02 de janeiro de 2017 Mário gravou a legítima de Clara com cláusula de incomunicabilidade; além disso deixou toda a sua parte disponível para Júlio. Sobre a situação narrada assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (359, 39, 359, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (366,  1, 1, 1, 'Paulo precisa de um veículo automotor para entregar os produtos de seu estabelecimento aos clientes mas não tem numerário para adquiri-lo. Ele foi aconselhado por sua advogada a celebrar um contrato de arrendamento mercantil. Assinale a opção que indica as faculdades do arrendatário ao final desse contrato.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (366, 46, 366, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (369,  1, 1, 1, 'Borba Eletrônicos Ltda. celebrou contrato de abertura de crédito em conta corrente com o Banco Humaitá S/A lastreado em nota promissória emitida em garantia da dívida. Sobre a nota promissória e o contrato de abertura de crédito em conta corrente diante do inadimplemento do mutuário assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (369, 49, 369, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (375,  1, 1, 1, 'Tancredo ajuizou equivocadamente em abril de 2017 demanda reivindicatória em face de Gilberto caseiro do sítio Campos Verdes porque Gilberto parecia ostentar a condição de proprietário. Diante do narrado assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (375, 55, 375, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (377,  1, 1, 1, 'Lucas em litígio instaurado contra Alberto viu seus pedidos serem julgados procedentes em primeira instância o que veio a ser confirmado pelo tribunal local em sede de apelação. Com a publicação do acórdão proferido em sede de apelação na imprensa oficial Alberto interpôs recurso especial alegando que o julgado teria negado vigência a dispositivo de lei federal. Simultaneamente Lucas opôs embargos de declaração contra o mesmo acórdão suscitando a existência de omissão. Nessa situação hipotética ', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (377, 57, 377, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (380,  1, 1, 1, 'Em 2014 Túlio foi condenado definitivamente pela prática de um crime de estupro ao cumprimento de pena de 6 anos. Após preencher todos os requisitos legais foi a ele deferido livramento condicional. No curso do livramento Túlio vem novamente a ser condenado definitivamente por outro crime de estupro praticado durante o período de prova. Preocupada com as consequências dessa nova condenação a família de Túlio procura o advogado para esclarecimentos. Considerando as informações narradas o advogado de Túlio deverá esclarecer à família que a nova condenação funciona na revogação do livramento como causa', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (380, 60, 380, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (383,  1, 1, 1, 'Flávia conheceu Paulo durante uma festa de aniversário. Após a festa ambos foram para a casa de Paulo juntamente com Luiza amiga de Flávia sob o alegado desejo de se conhecerem melhor. Em determinado momento Paulo sem qualquer violência real ou grave ameaça ingressa no banheiro para urinar ocasião em que Flávia e Luiza colocam um pedaço de madeira na fechadura deixando Paulo preso dentro do local. Aproveitando-se dessa situação subtraem diversos bens da residência de Paulo e deixam o imóvel enquanto a vítima apesar de perceber a subtração não tinha condição de reagir. Horas depois vizinhos escutam os gritos de Paulo e chamam a Polícia. De imediato Paulo procura seu advogado para esclarecimentos sobre a responsabilidade penal de Luiza e Flávia. Considerando as informações narradas o advogado de Paulo deverá esclarecer que as condutas de Luiza e Flávia configuram crime de', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (383, 63, 383, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (391,  1, 1, 1, 'Ferdinando trabalha na sociedade empresária Alfa S.A. há 4 anos mas anda desestimulado com o emprego e deseja dar um novo rumo à sua vida retornando em tempo integral aos estudos para tentar uma outra carreira profissional. Imbuído desta intenção Ferdinando procurou seu chefe em 08/03/2018 e apresentou uma proposta para de comum acordo ser dispensado da empresa com formulação de um distrato. Diante do caso apresentado e dos termos da CLT assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (391, 71, 391, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (396,  1, 1, 1, 'Silvio contratou você como advogado para ajuizar ação trabalhista em face do empregador. Entretanto na audiência o juiz constatou que não havia procuração nos autos. Diante disso você requereu fosse efetivado registro em ata de audiência no qual Silvio o constituía como procurador. Silvio anuiu com o requerimento. Com base na hipótese narrada nos termos da CLT assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (396, 76, 396, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (400,  1, 1, 1, 'Em determinada Vara do Trabalho foi prolatada uma sentença que após publicada não foi objeto de recurso por nenhum dos litigantes. Quinze meses depois uma das partes ajuizou ação rescisória perante o Tribunal Regional do Trabalho local tendo o acórdão julgado improcedente o pedido da rescisória. Ainda inconformada a parte deseja que o TST aprecie a demanda. Assinale a opção que indica na hipótese o recurso cabível para o Tribunal Superior do Trabalho.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (400, 80, 400, 5);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (401,  1, 1, 1, 'Rafaela advogada atua como árbitra em certa lide. Lena também regularmente inscrita como advogada perante a OAB exerce atualmente a função de mediadora. Ambas no exercício de suas atividades tomaram conhecimento de fatos relativos às partes envolvidas. Todavia apenas foi solicitado a Rafaela que guardasse sigilo sobre tais fatos. Considerando o caso narrado assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (401, 1, 401, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (402,  1, 1, 1, 'O advogado Fabrício foi contratado por José para seu patrocínio em processo judicial por meio de instrumento firmado no dia 14/11/2012. No exercício do mandato Fabrício distribuiu em 23/11/2012 petição inicial em que José figurava como autor. No dia 06/11/2013 nos autos do processo Fabrício foi intimado de sentença a qual fixou honorários advocatícios sucumbenciais no valor de dez mil reais em seu favor. A referida sentença transitou em julgado em 21/11/2013. Considerando que não houve causa de suspensão ou interrupção do prazo prescricional de acordo com a disciplina do Estatuto da Advocacia e da OAB assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (402, 2, 402, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (403,  1, 1, 1, 'O advogado Fred dirigiu-se em certa ocasião a uma delegacia de polícia e a um presídio a fim de entrevistar clientes seus que se encontravam respectivamente prestando depoimento e preso. Na mesma data o advogado Jorge realizou audiências na sede de um juizado especial cível e no interior de certo fórum regional da comarca. Considerando o disposto no Estatuto da Advocacia e da OAB assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (403, 3, 403, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (407,  1, 1, 1, 'O advogado José Maria celebrou contrato de mandato há muitos anos com o cliente Antônio para defendê-lo extrajudicialmente em certa questão. O instrumento não previu de forma expressa o prazo de duração do mandato. Considerando a hipótese descrita assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (407, 7, 407, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (420,  1, 1, 1, 'Maria Olímpia é demitida pela Embaixada de um país estrangeiro em Brasília por ter se recusado a usar véu como parte do seu uniforme de serviço. Obteve ganho de causa na reclamação trabalhista que moveu mas como o Estado não cumpriu espontaneamente a sentença foi solicitada a penhora de bens da Embaixada. Nesse caso a penhora de bens do Estado estrangeiro', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (420, 20, 420, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (425,  1, 1, 1, 'Admita que em 2016 foi criado um Território Federal no Brasil dividido em municípios. Joaquim reside nesse Território e recebeu da União no presente ano uma guia para o pagamento do Imposto sobre a Propriedade Predial e Territorial Urbana (IPTU) do seu imóvel. Na semana seguinte recebeu também uma guia do município em que mora. Levando em conta a situação descrita assinale a afirmativa correta.', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (425, 25, 425, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (434,  1, 1, 1, 'Gabriela pequena produtora rural que desenvolve atividade pecuária é avisada por seu vizinho sobre necessidade de registrar seu imóvel rural no Cadastro Ambiental Rural (CAR) sob pena de perder a propriedade do bem. Sobre a hipótese assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (434, 34, 434, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (450,  1, 1, 1, 'Cruz Machado pretende iniciar o exercício individual de empresa e adotar como firma exclusivamente o nome pelo qual é conhecido pela população de sua cidade – “Monsenhor”. De acordo com as informações acima e as regras legais de formação de nome empresarial para o empresário individual assinale a afirmativa correta.', 'C', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (450, 50, 450, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (451,  1, 1, 1, 'Uma fábrica da sociedade empresária Tratores Ltda. despejou 10 toneladas de lixo reciclável no rio Azul que corta diversos municípios do estado do Paraná. Em decorrência de tal fato constatou-se a redução da flora às margens do rio. Sobre a medida cabível em tal cenário assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (451, 51, 451, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (452,  1, 1, 1, 'Marina propôs ação de reconhecimento e extinção de união estável em face de Caio que foi regularmente citado para comparecer à audiência de mediação. Sobre a audiência de mediação assinale a afirmativa correta.', 'D', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (452, 52, 452, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (455,  1, 1, 1, 'Cláudia intimada pelo juízo da Vara Z para pagar a Cleide o valor de R$ 20.000 00 com fundamento em cumprimento definitivo de sentença realiza no prazo de 15 dias o pagamento de R$ 5.000 00. De acordo com o que dispõe o CPC/2015 deve incidir', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (455, 55, 455, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (471,  1, 1, 1, 'Paulo é policial militar da ativa da Brigada Militar do Rio Grande do Sul. Como policial militar trabalha em regime de escala 24h x 72h.Nos dias em que não tem plantão no quartel atua como segurança em uma joalheria de um shopping center onde tem que trabalhar três dias por semana não pode se fazer substituir por ninguém recebe remuneração fixa mensal e tem que cumprir uma rotina de 8 horas a cada dia laborado. Os comandos do trabalho lhe são repassados pelo gerente-geral da loja sendo que ainda ajuda nas arrumações de estoque na conferência de mercadorias e em algumas outras funções internas. Paulo não teve a CTPS anotada pela joalheria. Diante dessa situação à luz das normas da CLT e da jurisprudência consolidada do TST assinale a afirmativa correta.', 'A', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (471, 71, 471, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into questions (id, professor_id, coordinator_id, subarea_id, statement, right_alternative, approved) 
values (474,  1, 1, 1, 'Em 2018 um sindicato de empregados acertou em acordo coletivo com uma sociedade empresária a redução geral dos salários de seus empregados em 15% durante 1 ano. Nesse caso conforme dispõe a CLT ', 'B', true);
insert into practiseexam_questions (id, serial_number, question_id, practise_exam_id) 
values (474, 74, 474, 6);
insert into alternatives (id, question_id, professor_id, letter, description, correct) 
...
insert into participations (id, practise_exam_id, student_id, numberOfQuestions)
values (1, 1, 1, 20);
insert into participations (id, practise_exam_id, student_id, numberOfQuestions)
values (2, 1, 1, 5);
insert into participations (id, practise_exam_id, student_id, numberOfQuestions)
